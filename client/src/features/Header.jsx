    ...
    <header className="sticky top-0 z-50 bg-slate-700 shadow-md">
      <div className="flex justify-between items-center max-w-6xl mx-auto py-4 px-3">
        ...
        <ul className="flex items-center gap-3">
          <Link to="/about">
            <li className="hidden sm:inline-flex items-center gap-1 text-sm text-slate-200 hover:underline">
          ...
          <Link to="/profile">
            {currentUser ? (
              ...
              <li className="hidden text-slate-200 md:flex items-center gap-1 text-sm font-bold hover:underline">
              ...
              <DropdownMenuContent className="w-40 bg-slate-700 border border-slate-500 text-slate-200">
                <DropdownMenuItem className="hover:bg-red-100">
                  <Link to="/about" className="w-full py-1">
                    <li className="w-full flex items-center justify-between text-sm text-slate-200 hover:text-slate-700">
                      About <Info className="w-4 h-4" />
                    </li>
                  </Link>
                </DropdownMenuItem>
                ...
                <DropdownMenuItem>
                  {currentUser ? (
                    <Link to="/sign-in" className="w-full">
                      <li className="w-full flex items-center justify-between text-sm text-slate-200 hover:text-slate-70">
